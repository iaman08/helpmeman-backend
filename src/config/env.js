...
module.exports = {
  ...
  smtp: {
    ...
    fromEmail: process.env.FROM_EMAIL || process.env.BREVO_FROM_EMAIL || 'admin.helpmeman@gmail.com',
  },
  brevo: {
    apiKey: process.env.BREVO_API_KEY,
    fromEmail: process.env.BREVO_FROM_EMAIL || process.env.FROM_EMAIL || 'admin.helpmeman@gmail.com',
  },
  google: {
