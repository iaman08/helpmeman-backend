...
async function main() {
  ...
  const categories = await Promise.all([
    prisma.category.upsert({ where: { slug: 'jee-neet-prep' }, update: {}, create: { name: 'JEE Prep', slug: 'jee-neet-prep', icon: '📚', description: 'Guidance from top IIT & NIT toppers' } }),
    prisma.category.upsert({ where: { slug: 'medical-neet' }, update: {}, create: { name: 'Medical & NEET UG', slug: 'medical-neet', icon: '🩺', description: 'Guidance from top AIIMS & medical college toppers' } }),
    prisma.category.upsert({ where: { slug: 'health-nutrition' }, update: {}, create: { name: 'Health & Nutrition', slug: 'health-nutrition', icon: '🥗', description: 'Diet, lifestyle & wellness guidance by doctors & clinical nutritionists' } }),
    prisma.category.upsert({ where: { slug: 'law' }, update: {}, create: { name: 'Law & Legal Guidance', slug: 'law', icon: '⚖️', description: 'CLAT prep, NLU guidance & court litigation practice' } }),
  ...
  const mentorProfiles = [
    ...
    {
      user: { name: 'Dr. Ananya Roy', email: 'ananya.mentor@helpmeman.com' },
      mentor: {
        displayName: 'Dr. Ananya Roy',
        bio: 'NEET UG All India Rank 34. 4th Year MBBS Student at AIIMS New Delhi. Helping medical aspirants master Biology NCERT retention, Physics numerical strategy, dropper year planning, and AIIMS counseling.',
        institutionType: 'COLLEGE',
        institutionName: 'AIIMS New Delhi',
        institutionEmail: 'ananya@aiims.edu',
        department: 'Medicine (MBBS)',
        graduationYear: 2026,
        currentRole: 'MBBS Student (NEET AIR 34)',
        company: 'AIIMS New Delhi',
        linkedinUrl: 'https://linkedin.com/in/drananyaroy',
        expertise: ['NEET Strategy', 'AIIMS Prep', 'Biology NCERT', 'Dropper Roadmap', 'MBBS Counseling'],
        pricePerSession: 39900,
        sessionDuration: 45,
        rating: 5.0,
        totalSessions: 52,
        categorySlug: 'medical-neet',
    ...
    {
      user: { name: 'Dr. Rohan Mehta', email: 'rohan.mentor@helpmeman.com' },
      mentor: {
        displayName: 'Dr. Rohan Mehta',
        bio: 'MBBS Doctor & Certified Clinical Nutritionist. Guiding students, professionals, and athletes on personalized diet planning, clinical nutrition, energy optimization, weight management, and healthy living.',
        institutionType: 'COMPANY',
        institutionName: 'Apollo Health / Independent',
        institutionEmail: 'rohan@apollohealth.com',
        department: 'Clinical Nutrition & General Medicine',
        graduationYear: 2021,
        currentRole: 'Doctor & Clinical Nutritionist',
        company: 'Apollo Health',
        linkedinUrl: 'https://linkedin.com/in/drrohanmehta',
        expertise: ['Diet Planning', 'Clinical Nutrition', 'Student Health', 'Lifestyle Management', 'Energy & Focus'],
        pricePerSession: 49900,
        sessionDuration: 45,
        rating: 4.9,
        totalSessions: 38,
        categorySlug: 'health-nutrition',
    ...
    {
      user: { name: 'Adv. Vikramaditya Sharma', email: 'vikram.mentor@helpmeman.com' },
      mentor: {
        displayName: 'Adv. Vikramaditya Sharma',
        bio: 'Advocate at the High Court of Delhi and NLSIU Bangalore Alumnus. Specializing in CLAT UG/PG exam strategy, Moot Court preparation, NLU admission guidance, and corporate litigation careers.',
        institutionType: 'COMPANY',
        institutionName: 'High Court of Delhi',
        institutionEmail: 'vikram@delhihc.nic.in',
        department: 'Corporate & Litigation Law',
        graduationYear: 2020,
        currentRole: 'High Court Advocate',
        company: 'Delhi High Court',
        linkedinUrl: 'https://linkedin.com/in/advvikramsharma',
        expertise: ['CLAT Prep', 'NLU Selection', 'Moot Court', 'Corporate Law', 'Litigation'],
        pricePerSession: 44900,
        sessionDuration: 45,
        rating: 5.0,
        totalSessions: 29,
        categorySlug: 'law',
